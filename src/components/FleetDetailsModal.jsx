...
const FleetDetailsModal = ({ fleet, onClose, users, isAdmin, refreshFleets }) => {
    ...
    const handleImageChange = (e) => {
        ...
        if (files.length + (fleet.images?.length || 0) - removedImages.length + newImages.length > 5) {
            ...
            <div className={`bg-white rounded-lg shadow-xl w-full max-w-4xl overflow-hidden relative animate-fade-in-up flex flex-col md:flex-row max-h-[90vh] overflow-y-auto`}>
                ...
                <div className="w-full md:w-1/2 bg-gray-100 p-4 flex flex-col">
                    ...
                    <div className="space-y-4">
                        ...
                        {isEditing && (fleet.images.length - removedImages.length + newImages.length < 5) && (
                        ...
                        {isEditing ? (
                            <div className="space-y-3">
                                ...
                                <div className="flex gap-2 pt-4">
                                    <button onClick={handleSave} className="flex-1 bg-green-600 text-white py-2 rounded shadow hover:bg-green-700">Save Changes</button>
                                ...
                                <div className="pt-2 text-center">
                                    <button onClick={handleDelete} className="text-red-500 text-sm hover:underline">Delete Vehicle</button>
                                </div>
                            </div>
                        ) : (
                            <>
                                ...
                                {user && user.role !== 'viewer' && fleet.owner && (
